    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?= U('test/add') ?>"><i class="fa fa-circle-o"></i> 新增</a></li>
                    <li><a href="<?= U('test/index') ?>"><i class="fa fa-circle-o"></i> 列表</a></li>
                </ul>
                </li>
            </ul>
            <!-- /.sidebar-menu -->
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?= $value['content'] ?></td>
                                    <td>
                                        <img style="width: 100px;" src="<?= IMG_SHOW . $value['logo'] ?>" alt="">
                                    </td>
                                    <td>
                                        <a class="btn btn-success" href="<?= U('edit',['id'=>$value['id']]) ?>">编辑</a>
                                        <a class="btn btn-info" href="<?= U('del',['id'=>$value['id']]) ?>">删除</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
